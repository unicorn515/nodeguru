...
module.exports = function (done) {
  ...
  $.method('topic.add').check({
    authorId: {required: true, validate: (v) => vld.isMongoId(String(v))},
    title: {required: true},
  ...
  $.method('topic.get').check({
    _id: {required: true, validate: (v) => vld.isMongoId(String(v))},
  });
  ...
  $.method('topic.list').check({
    authorId: {validate: (v) => vld.isMongoId(String(v))},
    tags: {validate: (v) => Array.isArray(v)},
    skip: {validate: (v) => v >= 0},
  ...
  $.method('topic.comment.get').check({
    _id: {required: true, validate: (v) => vld.isMongoId(String(v))},
    cid: {required: true, validate: (v) => vld.isMongoId(String(v))},
  });
